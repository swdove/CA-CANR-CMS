(function($){
	...
	$.fn.repeaterShowcollapse = function() { 
		...
		// If the repeater is empty or fixed - hide (target the first repeater to support nested repeaters)
		$repeater = $(this).find('.acf-repeater').first();
		if( $repeater.attr("data-max") == "1" ) {
