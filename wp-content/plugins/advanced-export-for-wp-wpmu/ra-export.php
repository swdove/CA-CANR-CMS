...
function ra_do_export() {
	if(current_user_can('edit_files')) {
		...
		ra_export_wp_xml( $author, $category, $post_type, $status, $start_date, $end_date, $terms );
		die();
	}
}	
function ra_export_wp_xml($author='', $category='', $post_type='', $status='', $start_date='', $end_date='', $terms = '') {
